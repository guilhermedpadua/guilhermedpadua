...
Formado em Ciência e Tecnologia pela UFMA.

Engenheiro de IA em formação, com background em desenvolvimento web (front-end e back-end). Foco atual em agentes inteligentes, RAG e integração com LLMs.

🎯 Atualmente:
- Cursando "Engenheiro de Agentes de IA" na Alura
- Participando do Trilhas Inova - Automação com IA

📚 Projetos recentes:
- TCC concluído: "Agente de Inteligência Artificial para Apoio à Criação de Conteúdo Didático: Uma Proposta Fundamentada em Necessidades Docentes"
